...
from mirascope_cli.constants import CURRENT_REVISION_KEY, LATEST_REVISION_KEY
from mirascope_cli.enums import MirascopeCommand
from mirascope_cli.schemas import (
    ClassInfo,
    FunctionInfo,
    MirascopeCliVariables,
    MirascopeSettings,
)
from mirascope_cli.utils import (
    PromptAnalyzer,
...
def _get_mirascope_ini() -> str:
    ...
    mirascope_ini_path = Path("mirascope_cli/generic/mirascope.ini.j2")
    return mirascope_ini_path.read_text(encoding="utf-8")


def _get_prompt_template() -> str:
    """Get the contents of the prompt_template.j2 file"""
    prompt_template_path = Path("mirascope_cli/generic/prompt_template.j2")
