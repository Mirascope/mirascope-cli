...
@patch("mirascope_cli.commands.remove.get_user_mirascope_settings")
@patch("mirascope_cli.commands.remove.get_prompt_versions")
@patch("mirascope_cli.commands.remove.find_prompt_path")
@patch("mirascope_cli.commands.remove.find_prompt_paths")
@patch("os.remove")
def test_remove(
